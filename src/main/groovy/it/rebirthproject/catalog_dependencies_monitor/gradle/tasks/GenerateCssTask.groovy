...
abstract class GenerateCssTask extends DefaultTask {
    ...
    private static final String CSS_STYLES_CONTENT = GenerateCssTask.classLoader.getResourceAsStream('catalog-styles.css').text

    @TaskAction
    void executeTask() {
        outputs.files.singleFile.setText(CSS_STYLES_CONTENT)
    }
}